...
1.  **Código Fuente:** Carpeta comprimida (.zip) con el código limpio (excluyendo `node_modules`).
2.  **Documentación:** Este archivo `README.md`.
3.  **URL de Despliegue:** Enlace a la aplicación funcionando en vivo (ej. Render/Railway).
4.  **Video Demostrativo (Opcional):** Un breve clip de 2 minutos mostrando la inserción de un dato y su validación instantánea.
